    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div style="border-radius: 50%;">
                                <img src="<?= base_url('assets/images/profile/default.png'); ?>" class="rounded mx-auto d-block" alt="profile" id="profile-form" style="width: 150px; height: 150px;">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-sm btn-round btn-primary btn-simpan" onclick="create()">Update User</button>
            </div>
        </div>
    </div>
</div>
